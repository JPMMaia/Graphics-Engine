...
float CalculateTesselationFactor(float3 positionW)
{
	...
	//	If distanceToEye in [0, max_tesselation_distance], then tesselation_factor = min_tesselation_factor
	//	If distanceToEye in ]max_tesselation_distance, min_tesselation_distance[, then tesselation_factor varies linearly in [min_tesselation_factor, max_tesselation_factor]
