...
{
	m_shaders["StandardVS"] = Shader::CompileShader(L"GraphicsEngine/Shaders/DefaultVertexShader.hlsl", nullptr, "main", "vs_5_1");
	...
	m_shaders["OpaquePS"] = Shader::CompileShader(L"GraphicsEngine/Shaders/DefaultPixelShader.hlsl", opaqueDefines, "main", "ps_5_1");
	...
	m_shaders["AlphaTestedPS"] = Shader::CompileShader(L"GraphicsEngine/Shaders/DefaultPixelShader.hlsl", alphaTestedDefines, "main", "ps_5_1");

	m_shaders["HorizontalBlurCS"] = Shader::CompileShader(L"GraphicsEngine/Shaders/BlurComputeShader.hlsl", nullptr, "HorizontalBlur", "cs_5_1");
	m_shaders["VerticalBlurCS"] = Shader::CompileShader(L"GraphicsEngine/Shaders/BlurComputeShader.hlsl", nullptr, "VerticalBlur", "cs_5_1");
